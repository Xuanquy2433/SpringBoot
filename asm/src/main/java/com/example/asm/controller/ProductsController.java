...
public class ProductsController {
    ...
    //      if (id != 0) {
    //          ProductDto productEdit = productService.findProductsById(id);
    ...
    //  public String createProducts(Model model, @Valid @ModelAttribute("product") ProductDto dto,
    ...
    //  public String editProducts(Model model, @Valid @ModelAttribute("product") ProductDto dto,
    //          BindingResult result) {
    //      if (result.hasErrors()) {
    //          // đẩy lại view và đưa ra thông báo lỗi
    //          System.out.println("CO EROR");
